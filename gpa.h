...
private:
    ...
    float credits = 3.00; //defaulting all course credits to 3
...
public:
 ...
 //mutators
    ...
    void Str_Flt(string); //converts string to float
 ...
 //accessors
    float getGrades(int); //returns Grades[4] values by chosen element
